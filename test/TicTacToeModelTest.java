...
public class TicTacToeModelTest {
  ...
  /**
   * Test for invalid state exception after the game is over.
   */
  ...
  /**
   * Test for invalid row of position out of bounds.
   */
  ...
  /**
   * Test for invalid column of position out of bounds.
   */
  @Test(expected = IllegalArgumentException.class)
   ...
   */
  @Test
  public void testBordFullWinner() {
    // TODO: test case where board is full AND there is a winner
    TicTacToe test = new TicTacToeModel();
    test.move(0, 0);
    test.move(0, 1);
    test.move(2, 0);
    test.move(1, 0);
